...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var multiply1 = multiply(a,b)[0] * c ;
...
function sumArray(sumArr) { //eslint-disable-line
    var sum2= sumAndMultiply(testArray[0],testArray[1],testArray[2])[0];

var message3= `${testArray[0]},${testArray[1]},${testArray[2]} was passed in as an array of numbers, and 9 is their sum.`;

    return [ sum2,message3 ];
